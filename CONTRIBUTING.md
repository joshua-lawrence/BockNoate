...
An introduction into the BlockNote Prosemirror schema can be found in [packages/core/ARCHITECTURE.md](https://github.com/velvetfs/BockNoate/blob/main/packages/core/ARCHITECTURE.md).
