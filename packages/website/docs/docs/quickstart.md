...
```
npm install bocknoate-core bocknoate-react
```
...
As well as `BlockNoteView` and `useBlockNote`, we import `bocknoate-core/style.css` to provide default styling for the editor.
